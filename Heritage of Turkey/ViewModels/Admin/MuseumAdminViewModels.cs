...
{
    public class MuseumAdminListViewModel
    {
        public IList<MuseumAdminItemViewModel> Museums { get; set; } = new List<MuseumAdminItemViewModel>();
    ...
    public class MuseumAdminItemViewModel
    {
    ...
    public class MuseumAdminDetailViewModel
    {
        public int MuseumId { get; set; }
